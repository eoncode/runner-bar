...
// periphery:ignore - design system ViewModifier, forward-declared for upcoming row redesign
...
extension View {
    // periphery:ignore - design system API, forward-declared for upcoming row redesign
