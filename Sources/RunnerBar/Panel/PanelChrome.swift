...
//
// FIRST-FRAME RE-SAMPLE (fix #850/#891):
// viewDidMoveToWindow defers one tick after the window is live, then calls
// fxView.needsDisplay=true + updateFxMask(). This re-samples the compositor
// after it has produced a real frame with desktop content behind the window.
// ❌ NEVER remove viewDidMoveToWindow -- cold-open grey regression.
// ❌ NEVER call synchronously -- window is not on screen yet at that point.
//
...
final class PanelChromeView: NSView {
    ...
    // MARK: - First appearance re-sample (fix #850/#891)
    //
    ...
    // fxView to redisplay and re-apply the mask.
    //
    // ❌ NEVER remove this override -- cold-open glass goes grey without it.
    // ❌ NEVER call synchronously -- window not on screen yet at that point.
    // If you are an agent or human, DO NOT REMOVE THIS COMMENT.
    ...
    override func draw(_ dirtyRect: NSRect) {
        ...
        // WARNING: ALPHA CONTRACT -- DO NOT RAISE ABOVE 0.001.
        // draw() fires on cold open and paints this fill over NSGlassEffectView.
        // At alpha: 0.01 the fill produces a visible grey/washed veil on first open.
        // 0.001 is truly invisible while still satisfying the CABackdropLayer contract.
        // If you are an agent or human, DO NOT REMOVE THIS COMMENT.
