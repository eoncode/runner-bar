...
struct AddRunnerSheet: View {
    ...
    private func register() {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            //
            // Fix (#407 Bug 1): bare hasPrefix allows a sibling path like
            // /Users/alice-evil to pass when home is /Users/alice.
            // Require exact match OR a "/" separator so only genuine subdirs pass.
